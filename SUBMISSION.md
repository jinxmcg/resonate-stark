...
> **Submission status — 9 September 2026: the two ogbl-biokg entries and the
> ogbl-wikikg2 entry E were filed on OGB's form (pending validity check);
> nothing has been filed for STaRK-Prime.** The STaRK entry is proposed only. **P3 is the selected
